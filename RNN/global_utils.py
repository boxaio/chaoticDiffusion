...
def getParser(parser):
	...
	parser.add_argument('--hidden_layer_size', type=int, help='size of the hidden layers', required=False, default=20)
	parser.add_argument('--num_hidden_layers', type=int, help='number of the hidden layers', required=False, default=1)
	...
	parser.add_argument("--num_test_ICS", help="num_test_ICS", type=int, required=False, default=1)
	...
	parser.add_argument("--train_time_limit_in_hour", help="The maximum train time in hours", type=float, default=24, required=False)
